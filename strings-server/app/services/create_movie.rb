...
class CreateMovie
  def call
    ...
    puts "--------------------------------------"
    puts " The movies was created a total :#{Movie.count}"
    puts "--------------------------------------"
  end
  puts "Destroy Movies: #{Movie.count}"
end
